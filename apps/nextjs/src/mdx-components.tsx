...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h2: (props) => (
      <h2 className="mt-10 scroll-m-20 border-b pb-2 font-cal text-3xl first:mt-0" {...props}>
        {props.children}
      </h2>
    ),
    h3: (props) => (
    ...
    a: ({ children, href }) => {
      ...
      return (
        <Component href={href as Route} className="underline decoration-primary decoration-2 underline-offset-4">
          {children}
        </Component>
      );
    },
    ...
    code: (props) => (
      <code
        className="relative bg-subtle px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold text-subtle"
        {...props}
      />
    ),
